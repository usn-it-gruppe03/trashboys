...
<section class="py-3">
    <div class="container">
        <form action="">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-green fx-3d-green shadow-green w-100">Login</button>
            </div>
        </form>
    </div>
</section>
<section>
    <div class="container">
        ...
        <button class="btn btn-clay fx-3d-clay shadow-clay w-100" onclick="window.location.href='?p=register'">Lag ein brukar</button>
    </div>
</section>